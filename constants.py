...
class Constants(Enum):
    ...
    outputclasses: dict[str, str] = {
        ...
        # Example: <task id=... outputclass="procedure">
        # 4. File header
        'context': ('c_', 'concept', '<!DOCTYPE concept PUBLIC "-//OASIS//DTD DITA Concept//EN" "concept.dtd">'),
        'lpcontext': ('c_', 'concept', '<!DOCTYPE concept PUBLIC "-//OASIS//DTD DITA Concept//EN" "concept.dtd">'),
        'explanation': ('e_', 'concept', '<!DOCTYPE concept PUBLIC "-//OASIS//DTD DITA Concept//EN" "concept.dtd">'),
        'procedure': ('t_', 'task', '<!DOCTYPE task PUBLIC "-//OASIS//DTD DITA General Task//EN" "generalTask.dtd">'),
        'referenceinformation': ('r_', 'reference', '<!DOCTYPE reference PUBLIC "-//OASIS//DTD DITA Reference//EN" "reference.dtd">'),
        'legalinformation': ('r_', 'reference', '<!DOCTYPE reference PUBLIC "-//OASIS//DTD DITA Reference//EN" "reference.dtd">'),
        'frontcover': ('r_', 'reference', '<!DOCTYPE reference PUBLIC "-//OASIS//DTD DITA Reference//EN" "reference.dtd">'),
        'backcover': ('r_', 'reference', '<!DOCTYPE reference PUBLIC "-//OASIS//DTD DITA Reference//EN" "reference.dtd">')}
